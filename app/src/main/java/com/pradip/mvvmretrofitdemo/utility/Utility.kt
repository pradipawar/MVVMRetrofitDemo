package com.pradip.mvvmretrofitdemo.utility
...
object Utility {
    ...
    fun Context.isInternetAvaliable() : Boolean{
          try{
              ...
              return if(netInfo!=null && netInfo.isConnected){
                  ...
                  showErrorToast("Internet not avaliable. Please try again!!")
                    return false
    ...
    fun Context.showProgressBar() {
        try {
            ...
            progressBar = ProgressBar(this, null, androidx.constraintlayout.widget.R.attr.progressBarStyle)
            progressBar?.let { it1 ->
